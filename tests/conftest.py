...
def sample_numerical_data():
    ...
    data = {
        ...
        'organization_id': np.random.choice([1, 2, 3, 4], n_samples),
...
def sample_categorical_data():
    ...
    data = {
        ...
        'center': np.random.choice(['Center_A', 'Center_B', 'Center_C', 'Center_D'], n_samples),
        'organization_id': np.random.choice([1, 2, 3, 4], n_samples),
...
def mixed_data_sample():
    ...
    organizational_data = {
        ...
        'site_id': np.random.choice(['Site_01', 'Site_02', 'Site_03'], n_samples),
    }
    
    # Combine all data
    data = {**numerical_data, **categorical_data, **organizational_data}
